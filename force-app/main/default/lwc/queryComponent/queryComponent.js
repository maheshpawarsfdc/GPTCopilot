...
import generateResponse from '@salesforce/apex/LLMIntegration.generateResponse';
        ...
        if (this.messageInput && this.messageInput.trim() !== '') {
            ...
            try {
                ...
                if (chatGPTResponse && chatGPTResponse.trim() !== '') {
                    ...
                    const isSalesforceData = chatGPTResponse.startsWith('Here are the top'); // Example check for SF data

                    const assistantMessage = {
                        id: 'assistant-' + this.conversation.length,
                        role: 'assistant',
                        text: chatGPTResponse,
                        containerClass: isSalesforceData ? 'slds-chat-message slds-chat-message_inbound data-message' :'slds-chat-message slds-chat-message_inbound',
